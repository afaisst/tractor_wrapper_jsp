...
directories = {"hr_dir":"/stage/irsa-jointproc-data03/ACS_COSMOS/from_irsa/downloads/", # containing HR image (patch)
			...
			"job_output_dir":"/stage/irsa-jointproc-data03/TRACTOR/run_acs_jsp_full_SB4_Jan20/SANDBOX4/jobs/" # output directory where jobs are saved to disk
             }
...
for ii in range(len(hr_sci)):
	...
	#for tt in range(1):
		...
		userinput_this["hr_large_image_wht_name"] = "none"
